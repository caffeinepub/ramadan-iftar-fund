...
export interface Donation { 'timestamp' : Time, 'amount' : bigint }
export type Time = bigint;
export interface _SERVICE {
  'getAllDonations' : ActorMethod<[], Array<Donation>>,
  'getCampaignStats' : ActorMethod<[], CampaignStats>,
  'getMealsSponsored' : ActorMethod<[], bigint>,
  'getTotalAmountRaised' : ActorMethod<[], bigint>,
  'makeDonation' : ActorMethod<[bigint], undefined>,
}
