...
export class Backend implements backendInterface {
    ...
    async getMealsSponsored(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getMealsSponsored();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getTotalAmountRaised(): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.getTotalAmountRaised();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async makeDonation(arg0: bigint): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.makeDonation(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
